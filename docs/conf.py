...
project = "dls-multiconf"

# The full version, including alpha/beta/rc tags.
release = dls_multiconf_lib.__version__
...
html_theme_options = dict(
    ...
    gitlab_url="https://github.com/diamondlightsource/dls-multiconf/dls-multiconf",
    icon_links=[],
...
ultimate_replacements = {
    "$" + "{repository_name}": "dls-multiconf",
    "$" + "{package_name}": "dls_multiconf_lib",
    "$" + "{git_url}": "https://github.com/diamondlightsource/dls-multiconf",

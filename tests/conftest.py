...
# from dls_multiconf_lib.version import meta as version_meta
...
def logging_setup():
    ...
    logging.getLogger("luigi.dls_multiconf_scheduler").setLevel("INFO")
    logging.getLogger("urllib3.connectionpool").setLevel("INFO")

    logging.getLogger("dls_multiconf_lib.things").setLevel("INFO")

    # Messages about starting and stopping services.
    logging.getLogger("dls_multiconf_lib.base_aiohttp").setLevel("INFO")

    # All dls_multiconf database sql commands.
    # logging.getLogger("dls_multiconf_lib.dls_multiconf_databases.aiosqlite").setLevel("INFO")

    logging.getLogger("dls_multiconf_lib.dls_multiconf_contexts.classic").setLevel("INFO")
    logging.getLogger("dls_multiconf_lib.dls_multiconf_datafaces.context").setLevel("INFO")
